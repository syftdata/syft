...
export const BQ_HEAP_EVENT_SCHEMA_ALL = [
  ...
  },
  {
    name: 'type',
    type: 'string',
    description: 'For web autocaptured events, can be any of view page, click, submit, change, with push state events registered as view page events. For iOS auto-tracked events, can be touch, edit field, or a gesture recognizer you’ve defined. For custom events, this will be the custom event name.'
  },
  {
    name: 'library',
    type: 'string',
    description: 'Version of Heap library on which event occurred. Can be one of “web”, “iOS”, or “server”.'
  }
];
...
export const BQ_HEAP_EVENT_SCHEMA_WEB = [
  ...
  },
  {
    name: 'referrer',
    type: 'string',
    description: 'URL that linked to your site and initiated the session.If the user navigated directly to your site, or referral headers were stripped, then this value will appear as NULL downstream and as `direct` in the UI.'
  },
  {
    name: 'landing_page',
    type: 'string',
  ...
  },
  {
    name: 'utm_source',
    type: 'string',
    description: 'GA-based utm_source tag associated with the session’s initial pageview.'
  },
  {
    name: 'utm_campaign',
    type: 'string',
    description: 'GA-based utm_campaign tag associated with the session’s initial pageview.'
  },
  {
    name: 'utm_medium',
    type: 'string',
    description: 'GA-based utm_medium tag associated with the session’s initial pageview.'
  },
  {
    name: 'utm_term',
    type: 'string',
  ...
  },
  {
    name: 'utm_content',
    type: 'string',
    description: 'GA-based utm_content tag associated with the session’s initial pageview.'
  },
  {
    name: 'domain',
    type: 'string',
  ...
  },
  {
    name: 'path',
    type: 'string',
    description: 'Portion of the current URL following your domain, e.g. /docs for heap.io/docs.'
  },
  {
    name: 'hash',
    type: 'string',
    description: 'Portion of the current URL following the hash sign, e.g. #install for heap.io/docs#install.'
  },
  {
    name: 'query',
    type: 'string',
    description: 'Query params of the page’s current URL, e.g. ?utm_id=1234 for heap.io?utm_id=1234.'
  },
  {
    name: 'title',
    type: 'string',
...
export const BQ_HEAP_EVENT_SCHEMA_IOS = [
  ...
  },
  {
    name: 'app_version',
    type: 'string',
    description: 'Current version of iOS app, as determined by CFBundleShortVersionString.'
  },
  {
    name: 'action_method',
    type: 'string',
    description: 'Name of the action method triggered by this event, e.g. loginButtonWasPressed.'
  },
  {
  ...
  },
  {
    ...
    type: 'string',
    description: 'Underlying class name of an iOS action’s target, e.g. UITableCellView.'
  },
  {
    name: 'target_view_name',
    type: 'string',
    description: 'Instance variable name of an iOS action’s target, e.g. loginButtonView.'
  },
  {
    name: 'target_a11y_id',
    type: 'string',
...
export const BQ_HEAP_USERS_SCHEMA = [
  ...
  },
  {
    name: 'identity',
    type: 'string',
    description: 'User’s username or other unique token, passed via heap.identify API. Must be unique.'
  },
  {
    name: 'handle',
    type: 'string',
    description: 'User’s username or other unique token, passed in via heap.addUserProperties API.'
  },
  {
    name: 'email',
    type: 'string',
    description: 'User’s email address, passed in via heap.addUserProperties API.'
  },
  {
    name: 'joindate',
    type: 'timestamp',
  ...
  },
  {
    name: 'last_modified',
    type: 'timestamp',
    description: 'Timestamp without timezone of when the user’s data was last modified.'
  }
];
...
export const BQ_HEAP_SESSIONS_SCHEMA_ALL = [
  {
    name: 'event_id',
    type: 'number',
    description: 'ID of associated session event, randomly generated by Heap used internally by Heap for data syncing.'
  },
  {
    name: 'user_id',
    type: 'number',
  ...
  },
  {
    name: 'library',
    type: 'string',
    description: 'Version of Heap library which initiated the session. Can be one of “web” or “iOS”.'
  },
  {
    name: 'country',
    type: 'string',
