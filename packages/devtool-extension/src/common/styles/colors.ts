...
export const colorCss = (color: string) =>
  css({ color: `${color} !important` });
export const boxShadowCss = (boxShadow: string) => css({ boxShadow });
export const textShadowCss = (textShadow: string) => css({ textShadow });
export const iconShadowCss = (iconShadow: string) =>
  css({
    svg: {
      filter: `drop-shadow(${iconShadow})`,
    },
  });
export const backgroundCss = (background: string) =>
  css({
    background,
  });
export const borderCss = (border: string) =>
  css({
    border,
  });
